...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post prices_url, params: { price: { lab_test_id: @price.lab_test_id, sample_id: @price.sample_id } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { lab_test_id: @price.lab_test_id, sample_id: @price.sample_id } }
