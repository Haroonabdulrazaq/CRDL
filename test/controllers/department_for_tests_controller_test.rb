...
class DepartmentForTestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create department_for_test" do
    assert_difference('DepartmentForTest.count') do
      post department_for_tests_url, params: { department_for_test: { description: @department_for_test.description, title: @department_for_test.title, user_id: @department_for_test.user_id } }
    end
  ...
  test "should update department_for_test" do
    patch department_for_test_url(@department_for_test), params: { department_for_test: { description: @department_for_test.description, title: @department_for_test.title, user_id: @department_for_test.user_id } }
