...
class CurrenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create currency" do
    assert_difference('Currency.count') do
      post currencies_url, params: { currency: { currency: @currency.currency, samples_id: @currency.samples_id } }
    end
  ...
  test "should update currency" do
    patch currency_url(@currency), params: { currency: { currency: @currency.currency, samples_id: @currency.samples_id } }
