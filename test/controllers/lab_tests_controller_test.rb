...
class LabTestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create lab_test' do
    assert_difference('LabTest.count') do
      post lab_tests_url,
           params: { lab_test: { department_for_test_id: @lab_test.department_for_test_id, description: @lab_test.description,
                                 price_per_unit: @lab_test.price_per_unit, title: @lab_test.title, user_id: @lab_test.user_id } }
    end
